...
export const resourceTypeDependencies: ResourceTypeDependencies = {
  ...
  "kms.key": [],
  "lambda.event-source-mapping": ["lambda.function"],
  "lambda.function": ["ec2.security-group", "ec2.subnet", "iam.role", "logs.log-group"],
  "logs.log-group": [],
  "rds.cluster-pg": [],
  ...
  "rds.db": ["ec2.internet-gateway", "ec2.security-group", "logs.log-group", "rds.cluster", "rds.pg", "rds.subgrp"],
  "rds.pg": [],
